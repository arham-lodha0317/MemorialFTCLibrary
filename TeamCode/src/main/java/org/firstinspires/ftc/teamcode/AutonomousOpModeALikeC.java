...
@Autonomous(name="AutonomousALikeC", group="Memorial")

public class AutonomousOpModeALikeC extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        toTemp();
        sleep(250);
        encoderDrive(TURN_SPEED, -.03,.03,10);
